            ...
            <div className=" p-6 ml-12 flex items-center justify-start flex-grow">
                <div className="ml-12 max-w-md w-full p-6 bg-white rounded shadow-lg">
                    <div className="flex items-center justify-start">
                        <img src="/iconBlueNew.png" alt="Icon" width={75} height={75} />
                        <h1 className="text-3xl font-bold mb-2 ml-10">MyMoneyMate</h1>
                    </div>
                    ...
                    <p className="text-xl text-gray-600 mb-8">To begin, add @My_Money_Mate_bot to your Telegram group</p>
                    <div className="flex justify-center">
                        <a
                            href="https://t.me/My_Money_Mate_bot"
                            target="_blank"
